        ...
        <div className="hero-premium-in">
          <div className="hero-premium-content">
            ...
            <div className="hero-quick-cats">
              <div className="hero-quick-cat-item" onClick={() => { window.location.href = 'https://buywheels.netlify.app/'; }}>
      ...
      <section className="section cats-sec" id="cats">
        <div className="section-in">
          ...
          <div className="cats-grid-new">
            ...
            {/* Card 1: Cars */}
            <div className="cat-card new-car-card r" onClick={() => { window.location.href = 'https://buywheels.netlify.app/'; }}>
